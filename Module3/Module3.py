...
def process_data(data):
        ...
        for item in data:
                ...
                if item["car"]["car_year"] not in car_year_sale.keys():
                        car_year_sale[item["car"]["car_year"]] = 0
                car_year_sale[item["car"]["car_year"]] += item["total_sales"]
        max_car_year_sale = max(car_year_sale.items(), key=operator.itemgetter(1))
        ...
        summary = [
                ...
                max_car_year_sale[0], max_car_year_sale[1])
        ]
...
def main(argv):
        ...
        message = emails.generate(sender, receiver, subject, new_summary, "/tmp/cars.pdf")
        emails.send(message)
